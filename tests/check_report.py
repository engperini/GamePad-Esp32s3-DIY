...
assert mapping == [1,2,4,15,12,9,10,12], mapping
assert len(set(mapping)) == 7 and all(1 <= usage <= 15 for usage in mapping)
assert sum(1 << (usage-1) for usage in set(mapping)) == 0x4b0b
